...
(
    ...
    constraint notes_created_by_fkey foreign KEY (created_by) references profiles (id) on update CASCADE on delete CASCADE,
    constraint notes_video_id_fkey foreign KEY (video_id) references videos (id) on update CASCADE on delete CASCADE
) TABLESPACE pg_default;
